...
public class DataSeeder implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent arg0) {
		...
		// Admin account
		if (userRepository.findByEmail("longhoang.admin@gmail.com") == null) {
			NguoiDung admin = new NguoiDung();
			admin.setEmail("longhoang.admin@gmail.com");
			admin.setPassword(passwordEncoder.encode("1302"));
			admin.setHoTen("Long Hoàng");
		...
		// Member account
		if (userRepository.findByEmail("longhoang.member@gmail.com") == null) {
			NguoiDung member = new NguoiDung();
			member.setEmail("longhoang.member@gmail.com");
			member.setPassword(passwordEncoder.encode("1302"));
			member.setHoTen("Hoàng Long");
			HashSet<VaiTro> roles = new HashSet<>();
			roles.add(roleRepository.findByTenVaiTro("ROLE_MEMBER"));
		...
		// Shipper account
		if (userRepository.findByEmail("longhoang.shipper@gmail.com") == null) {
			NguoiDung member = new NguoiDung();
			member.setEmail("longhoang.shipper@gmail.com");
			member.setPassword(passwordEncoder.encode("1302"));
			member.setHoTen("Long Hoang");
			HashSet<VaiTro> roles = new HashSet<>();
